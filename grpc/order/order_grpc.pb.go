...
type OrderServiceClient interface {
	GetAllOrders(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetAllOrdersResponse, error)
}
...
func (c *orderServiceClient) GetAllOrders(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetAllOrdersResponse, error) {
...
type OrderServiceServer interface {
	GetAllOrders(context.Context, *Empty) (*GetAllOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) GetAllOrders(context.Context, *Empty) (*GetAllOrdersResponse, error) {
